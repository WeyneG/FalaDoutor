...
class RelatorioMedicosScreen extends StatefulWidget {
  const RelatorioMedicosScreen({super.key});

  @override
  State<RelatorioMedicosScreen> createState() => _RelatorioMedicosScreenState();
}

class _RelatorioMedicosScreenState extends State<RelatorioMedicosScreen> {
  ...
  Future<void> _carregarRelatorio() async {
    ...
    try {
      final relatorio = await RelatorioService.getRelatorioMedicos();
      setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Relatório de Médicos'),
              ...
              return Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        '$faixaEtaria ($quantidade médico${quantidade != 1 ? 's' : ''})',
              ...
              return Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        '${item['plano']} ($quantidade médico${quantidade != 1 ? 's' : ''})',
                        style: const TextStyle(fontSize: 16),
                      ),
                    ),
                  ],
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Sem Plano ($semPlano médico${semPlano != 1 ? 's' : ''})',
                        style: const TextStyle(fontSize: 16),
                      ),
                    ),
                  ],
